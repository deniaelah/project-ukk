    ...
    <div class="card p-4">
        ...
        <form action="{{ route('alat.update', $alat->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="kategori_id" class="form-control">
                    ...
                    @foreach ($kategoris as $kategori)
                        <option value="{{ $kategori->id }}" @selected(old('kategori_id', $alat->kategori_id ?? '') == $kategori->id)>
                            {{ $kategori->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <textarea name="spesifikasi" class="form-control" rows="3">{{ old('spesifikasi', $alat->spesifikasi) }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah_total" class="form-control"
                       value="{{ old('jumlah_total', $alat->jumlah_total) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah_tersedia" class="form-control"
                       value="{{ old('jumlah_tersedia', $alat->jumlah_tersedia) }}" required>
            </div>
